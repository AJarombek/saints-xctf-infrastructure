...
class TestSXCTFAuth(unittest.TestCase):
    ...
    def test_rotate_secret_lambda_role_exists(self) -> None:
        ...
        """
        self.assertTrue(
            IAM.iam_role_exists(role_name=f"rotate-secret-lambda-role-{self.env}")
        )
    ...
    @unittest.skipIf(
        not prod_env, "Development authorizer AWS Lambda function not under test."
    )
    def test_authorizer_lambda_role_exists(self) -> None:
        ...
        """
        self.assertTrue(
            IAM.iam_role_exists(role_name=f"authorizer-lambda-role-{self.env}")
        )
    ...
    def test_authorizer_lambda_function_has_iam_role(self) -> None:
        ...
        self.assertTrue(
            Lambda.lambda_function_has_iam_role(
                function_name=function_name, role_name="authorizer-lambda-role"
            )
        )
    ...
    @unittest.skipIf(
        not prod_env, "Development rotate AWS Lambda function not under test."
    )
    ...
    def test_rotate_lambda_function_has_iam_role(self) -> None:
        ...
        self.assertTrue(
            Lambda.lambda_function_has_iam_role(
                function_name=function_name, role_name="rotate-secret-lambda-role"
            )
        )
    ...
    @unittest.skipIf(
        not prod_env, "Development authenticate AWS Lambda function not under test."
    )
    ...
    @unittest.skipIf(
        not prod_env, "Development token AWS Lambda function not under test."
    )
    def test_authenticate_lambda_function_provisioned_concurrency_config(self) -> None:
        ...
        self.assertEqual(
            1, prov_concurrency_config.get("RequestedProvisionedConcurrentExecutions")
        )
        self.assertEqual(
            1, prov_concurrency_config.get("AvailableProvisionedConcurrentExecutions")
        )
        self.assertEqual(
            1, prov_concurrency_config.get("AllocatedProvisionedConcurrentExecutions")
        )
    ...
    def test_token_lambda_function_has_iam_role(self) -> None:
        ...
        self.assertTrue(
            Lambda.lambda_function_has_iam_role(
                function_name=function_name, role_name="token-lambda-role"
            )
        )
    ...
    def test_token_lambda_function_in_vpc(self) -> None:
        ...
        lambda_function_vpc_id = (
            lambda_function.get("Configuration").get("VpcConfig").get("VpcId")
        )
    ...
    def test_token_lambda_function_in_subnets(self) -> None:
        ...
        self.assertTrue(
            Lambda.lambda_function_in_subnets(
                function_name=function_name,
                subnets=[
