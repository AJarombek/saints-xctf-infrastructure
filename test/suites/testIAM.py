...
class TestIAM(unittest.TestCase):
    ...
    def rds_access_role_exists(self) -> None:
        ...
        self.assertTrue(
            role.get("Path") == "/saintsxctf/"
            and role.get("RoleName") == "rds-access-role"
        )
    ...
    def s3_access_role_exists(self) -> None:
        ...
        self.assertTrue(
            role.get("Path") == "/saintsxctf/"
            and role.get("RoleName") == "s3-access-role"
        )
    ...
    def rds_access_policy_attached(self) -> None:
        ...
        policy_response = self.iam.list_attached_role_policies(
            RoleName="rds-access-role"
        )
        policies = policy_response.get("AttachedPolicies")
        rds_policy = policies[0]
        self.assertTrue(
            len(policies) == 1 and rds_policy.get("PolicyName") == "rds-access-policy"
        )
    ...
    def s3_access_policy_attached(self) -> None:
        ...
        self.assertTrue(
            len(policies) == 1 and s3_policy.get("PolicyName") == "s3-access-policy"
        )
