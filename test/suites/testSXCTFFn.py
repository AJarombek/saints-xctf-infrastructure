...
class TestSXCTFFn(unittest.TestCase):
    def setUp(self) -> None:
        ...
        """
        self.apigateway: ApiGatewayClient = boto3.client(
            "apigateway", region_name="us-east-1"
        )
    ...
    def test_api_gateway_auth_role_exists(self) -> None:
        ...
        """
        self.assertTrue(
            IAM.iam_role_exists(role_name=f"api-gateway-auth-role-{self.env}")
        )
    ...
    def test_fn_saintsxctf_com_api_route53_record_exists(self) -> None:
        ...
        try:
            a_record = Route53.get_record(
                f"saintsxctf.com.", f"{self.domain_name}.", "A"
            )
        except IndexError:
        ...
        print(a_record)
        self.assertTrue(
            a_record.get("Name") == f"{self.domain_name}."
    ...
    @unittest.skipIf(
        not prod_env, "Development forgot password AWS Lambda function not under test."
    )
    ...
    @unittest.skipIf(
        not prod_env, "Development email AWS Lambda functions not under test."
    )
    ...
    @unittest.skipIf(
        not prod_env,
        "Development forgot password email AWS Lambda function not under test.",
    )
    def test_forgot_password_email_lambda_function_has_iam_role(self) -> None:
        ...
        self.assertTrue(
            Lambda.lambda_function_has_iam_role(
                function_name=function_name, role_name="email-lambda-role"
            )
        )
    ...
    def test_forgot_password_email_lambda_function_has_cloudwatch_log_group(
        self,
    ) -> None:
        """
        ...
        CloudWatchLogs.cloudwatch_log_group_exists(
            test_case=self, log_group_name=log_group_name, retention_days=7
        )

    @unittest.skipIf(
        not prod_env, "Development activation code AWS Lambda function not under test."
    )
    ...
    @unittest.skipIf(
        not prod_env,
        "Development activation code email AWS Lambda function not under test.",
    )
    ...
    def test_activation_code_email_lambda_function_has_cloudwatch_log_group(
        self,
    ) -> None:
        """
    ...
    @unittest.skipIf(
        not prod_env, "Development report email AWS Lambda function not under test."
    )
    ...
    @unittest.skipIf(
        not prod_env, "Development welcome email AWS Lambda function not under test."
    )
    ...
    @unittest.skipIf(
        not prod_env, "Development uasset user AWS Lambda function not under test."
    )
    ...
    def test_uasset_user_lambda_function_uses_layers(self) -> None:
        ...
        lambda_function_response = self.aws_lambda.get_function(
            FunctionName=function_name
        )
        lambda_function_layers: List[dict] = lambda_function_response.get(
            "Configuration"
        ).get("Layers")
    ...
    @unittest.skipIf(
        not prod_env, "Development uasset AWS Lambda functions not under test."
    )
    ...
    def test_uasset_user_lambda_function_has_iam_role(self) -> None:
        ...
        self.assertTrue(
            Lambda.lambda_function_has_iam_role(
                function_name=function_name, role_name="uasset-lambda-role"
            )
        )
    ...
    @unittest.skipIf(
        not prod_env, "Development uasset group AWS Lambda function not under test."
    )
    ...
    @unittest.skipIf(
        not prod_env,
        "Development uasset signed url user AWS Lambda function not under test.",
    )
    ...
    def test_uasset_signed_url_user_lambda_function_has_cloudwatch_log_group(
        self,
    ) -> None:
        """
        Test that a Cloudwatch log group exists for the uasset user AWS Lambda function.
    ...
    @unittest.skipIf(
        not prod_env,
        "Development uasset signed url group AWS Lambda function not under test.",
    )
    ...
    def test_uasset_signed_url_group_lambda_function_has_cloudwatch_log_group(
        self,
    ) -> None:
        """
